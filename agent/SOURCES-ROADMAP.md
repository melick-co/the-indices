...
|---|---|---|---|
| ABS via SDMX | CPI, WPI wages (verified); labour force, RPPI pending | monthly-quarterly | Home-market depth; step-change on AU series; budget/RBA calendar pegs |
...
| RBA statistical tables | Cash rate, credit (D1), household debt (E2), 10y yields (F17) | monthly | Divergence detector: yields vs inflation, credit vs income |
...
| World Bank WDI API | Population, GDP, market cap, inflation, unemployment (live) | rolling | Clean per-capita denominators for every flip check |
